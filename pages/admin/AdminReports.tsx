...
export const AdminReports: React.FC = () => {
  ...
  const appTypeData = [
    { name: 'Registration', count: applications.filter(a => a.type === 'Registration').length },
    { name: 'ID Renewal', count: applications.filter(a => a.type === 'ID Renewal').length },
    { name: 'Benefits', count: applications.filter(a => a.type.includes('Benefit')).length },
    { name: 'PhilHealth', count: applications.filter(a => a.type === 'PhilHealth').length },
  ];
